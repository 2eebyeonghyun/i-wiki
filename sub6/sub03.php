...
<body class="sub_ sub_<?=$_dep[0];?> sub_<?=$_dep[0].$_dep[1].$_dep[2];?>">
	...
	<div id="wrap" class="con sub6">
		<section>
			<article>
				<div class="inner">
					<h5 class="center-h3">보육정보<p>'보육정보'에서는 중랑구육아종합지원센터와 관련된 다양한 안내와 정보를 얻으실 수 있습니다.</p></h3>
                    ...
                    <table class="__tbl-list">
                    	...
                    	<tbody>
                    		<tr class="notice">
                    			...
                    			<td class="subject">
                    				<a href="<?=DIR?>/sub6/sub6_view3.php">코로나19 유행대비 어린이집용 대응 지침 11판 안내</a>
                    			</td>
                    			<td>2022-05-24</td>
                    			<td>857</td>
                    		</tr>
